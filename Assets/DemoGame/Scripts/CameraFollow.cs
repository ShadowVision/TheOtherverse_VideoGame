...
public class CameraFollow : MonoBehaviour 
{
	...
	public Transform targetTransform;		// Reference to the targetTransform's transform.
	...
	bool CheckXMargin()
	{
		...
		return Mathf.Abs(transform.position.x - targetTransform.position.x) > xMargin;
	}
	...
	bool CheckYMargin()
	{
		...
		return Mathf.Abs(transform.position.y - targetTransform.position.y) > yMargin;
	}
	...
	void TracktargetTransform ()
	{
		...
		if(CheckXMargin())
			...
			targetX = Mathf.Lerp(transform.position.x, targetTransform.position.x, xSmooth * Time.deltaTime);
		...
		if(CheckYMargin())
			...
			targetY = Mathf.Lerp(transform.position.y, targetTransform.position.y, ySmooth * Time.deltaTime);
